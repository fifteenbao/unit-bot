...
KEYWORD_RULES: list[tuple[str, str, str, str]] = [
    ...
    # 清洁
    (r"^双面拖布|^拖布、.*双面",     "cleaning", "双面履带拖布", "双面拖布(聚合)"),
    (r"^拖布$|^普通拖布",            "cleaning", "普通拖布", "普通拖布"),
    (r"拖布支架|拖布盘|拖布机械臂|拖布安装|拖布抬升|拖布伸缩|拖布震动|拖布电机|拖布.*防滑|拖布.*胶",
     "cleaning", "拖布支架", "拖布系统(聚合)"),
    (r"浮动中扫|滚刷.*电机|滚刷盖板|滚刷组件|滚刷本体",
     "cleaning", "浮动中扫", "滚刷系统(聚合)"),
    (r"主机边扫|边扫包胶|边扫组件|边刷电机", "cleaning", "边扫组件", "边刷(聚合)"),
    (r"^主机风机\|\||^风机\|\||主机风机、|主机吸尘风机",
     "power_motion", "主机吸尘风机", "吸尘风机"),
    (r"注清水泵|清水泵|加清泵",              "cleaning", "注清水泵", "注清水泵"),
    (r"清水盒|机身水箱",                     "cleaning", "清水盒", "主机水箱(聚合)"),
    (r"污水盒",                              "cleaning", "污水盒", "主机污水盒(聚合)"),
    (r"污水吸气|吸污管|吸污水管",            "cleaning", "污水盒", "吸污管路(聚合)"),
