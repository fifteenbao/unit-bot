...
面向产品 / 成本 / 研发团队，整个项目以 **PLANS 价值设计流程**（**P** 现状研究 → **L** 精益设计 → **A** 先进裁剪 → **N** 价值创新 → **S** 体系建设）为骨架，把竞品拆机分析、BOM 成本核算、降本优化、创新研判、体系建设串成一条工作流。支持 Codex / Claude Code / OpenClaw ，也可直接 CLI 使用。
